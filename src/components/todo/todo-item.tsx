                  ...
                  <div className="flex justify-center gap-2">
                    <Tooltip>
                      <div className="flex justify-center">
                        ...
                        <TooltipContent>
                          <p className="capitalize">Updates to this new todo</p>
                        </TooltipContent>
                      </div>
                    </Tooltip>
                    <Tooltip>
                      <div className="flex justify-center">
                        <TooltipTrigger>
                          <Button
                            variant={"secondary"}
                            className="flex gap-2"
                            onClick={() => props.setEditId(undefined)}
                          >
                            <BanIcon className="text-destructive/90" />
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                          <p className="capitalize">Cancel edit</p>
                        </TooltipContent>
                      </div>
                    </Tooltip>
                  </div>
            ...
            <>
              <div className="flex justify-center gap-2 items-center mb-6">
                <Tooltip>
                  <TooltipTrigger>
                    <Checkbox
                      ...
                      onCheckedChange={() => props.handleToggle(props.todo)}
                    />
                  </TooltipTrigger>
                  <TooltipContent>
                ...
                {props.todo.completed ? (
                  <p className="line-through capitalize">{props.todo.title}</p>
                ) : (
                  <p className="capitalize">{props.todo.title}</p>
                )}
              </div>
              <div className="flex justify-center gap-2 absolute bottom-2 w-full left-0">
                <Tooltip>
                  <TooltipTrigger>
                    <Button
                      variant={"secondary"}
                      onClick={() => props.setEditId(props.todo.id)}
                    >
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="capitalize">Delete this todo</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            </>
